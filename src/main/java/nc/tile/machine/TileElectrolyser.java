...
public class TileElectrolyser extends TileMachineFluidIn {
	...
	public TileElectrolyser() {
		super("electrolyser", 250000, 48000, 1, 4, true, true, 20000, 1000000, FluidRegistry.WATER, 12000, Config.electrolyserSpeed, Config.electrolyserEfficiency, ElectrolyserRecipes.instance());
	}

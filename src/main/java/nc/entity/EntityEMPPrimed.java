...
public class EntityEMPPrimed extends Entity {
	...
	private void explode(World world) {
        ...
        for (int i = -((int)(0.5D*Config.explosionRadius)); i <= ((int)(0.5D*Config.explosionRadius)); i++) {
    		for (int j = -((int)(0.5D*Config.explosionRadius)); j <= ((int)(0.5D*Config.explosionRadius)); j++) {
    			for (int k = -((int)(0.5D*Config.explosionRadius)); k <= ((int)(0.5D*Config.explosionRadius)); k++) {
    				if (i*i + j*j + k*k <= ((int)(0.5D*Config.explosionRadius))*((int)(0.5D*Config.explosionRadius)) && world.getTileEntity(x + i, y + j, z + k) != null) {

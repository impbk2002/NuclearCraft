...
import nc.block.accelerator.*;
import nc.block.basic.*;
import nc.block.crafting.*;
...
import nc.block.storage.*;
import nc.itemblock.accelerator.*;
import nc.itemblock.basic.*;
import nc.itemblock.crafting.*;
import nc.itemblock.generator.*;
import nc.itemblock.machine.*;
import nc.itemblock.nuke.*;
import nc.itemblock.quantum.*;
import nc.itemblock.reactor.*;
import nc.itemblock.storage.*;
...
public class NCBlocks {
	...
	private static void normal() {
		...
		NCBlocks.reactorGlass = new BlockReactorGlass().setBlockName("reactorGlass").setCreativeTab(tabNC)
				.setStepSound(Block.soundTypeGlass).setResistance(5.0F).setHardness(3.0F);
		GameRegistry.registerBlock(NCBlocks.reactorGlass, ItemBlockReactorGlass.class, "reactorGlass");
